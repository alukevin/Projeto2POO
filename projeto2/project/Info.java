...
public final class Info
   {
   public static final String  author         = "Victor Uchiyama/Wallace Silva/Douglas Moreira/Kevin Mansano";
   public static final String  sysName        = "Unit Converter";
   public static final String  copyRight      = "Copyright \u00A9 2020. " + author + ". All rights reserved.";
   public static final String  mission        = "Unit Converter Calculator";
